package org.imcharsi.vaadin.testtable.client;
...
import org.imcharsi.vaadin.testtable.client.TestTableWidget.VScrollTableBody.VScrollTableRow;
...
public class TestTableWidget extends FlowPanel implements HasWidgets,
     ...
     * in method {@link TableHead#updateCellsFromUIDL(com.vaadin.client.UIDL)}.
     * <p>
     * For internal use only. May be removed or replaced in the future.
     */
...
//                firstRowInViewPort = firstvisible;
                ...
                if (firstvisibleOnLastPage > -1) {
                    ...
                    Logger.getLogger("hi").info("firstvisibleOnLastPage:"+firstvisibleOnLastPage);
                } else {
                    scrollBodyPanel
                            .setScrollPosition(measureRowHeightOffset(firstvisible));
                    Logger.getLogger("hi").info("firstvisible:" + firstvisible);
                }
            }
            disableLazyScroller();
        }
    ...
    public class HeaderCell extends Widget {
        ...
        private void createFloatingCopy() {
            ...
            DOM.setElementProperty(floatingCopyOfHeaderCell, "className",
                    TestTableWidget.this.getStylePrimaryName() + "-header-drag");
        ...
        public void run() {
            ...
            if (isDynamicHeight() && totalRows == pageLength) {
                ...
                if (heightBefore != getOffsetHeight()) {
                    Util.notifyParentOfSizeChange(TestTableWidget.this, false);
                }
            }
            Scheduler.get().scheduleDeferred(new Command() {
    ...
    public class VScrollTableDropHandler extends VAbstractDropHandler {
        ...
        private void deEmphasis() {
            UIObject.setStyleName(getElement(),
                    TestTableWidget.this.getStylePrimaryName() + "-drag", false);
        ...
        private void emphasis(TableDDDetails details) {
            deEmphasis();
            UIObject.setStyleName(getElement(),
                    TestTableWidget.this.getStylePrimaryName() + "-drag", true);
