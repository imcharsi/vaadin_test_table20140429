...
public class TestTableConnector extends AbstractHasComponentsConnector implements
    ...
    public void updateFromUIDL(UIDL uidl, ApplicationConnection client) {
        ...
        // required.
        TestTableWidget.ContextMenuDetails contextMenuBeforeUpdate = getWidget().contextMenu;
     ...
     */
    public void showSavedContextMenu(TestTableWidget.ContextMenuDetails savedContextMenu) {
        if (isEnabled() && savedContextMenu != null) {
            Iterator<Widget> iterator = getWidget().scrollBody.iterator();
            while (iterator.hasNext()) {
                Widget w = iterator.next();
                TestTableWidget.VScrollTableBody.VScrollTableRow row = (TestTableWidget.VScrollTableBody.VScrollTableRow) w;
    ...
    public TooltipInfo getTooltipInfo(Element element) {
        ...
        if (element != getWidget().getElement()) {
            Object node = Util.findWidget(
                    ...
                    TestTableWidget.VScrollTableBody.VScrollTableRow.class);

            if (node != null) {
                TestTableWidget.VScrollTableBody.VScrollTableRow row = (TestTableWidget.VScrollTableBody.VScrollTableRow) node;
